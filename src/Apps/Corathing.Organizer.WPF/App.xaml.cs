...
using Corathing.Organizer.WPF.Utils;
...
using NavigationDialogService = Corathing.Organizer.WPF.Services.NavigationDialogService;
using ThemeService = Corathing.Organizer.WPF.Services.ThemeService;

namespace Corathing.Organizer.WPF;
